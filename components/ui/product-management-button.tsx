...
export default function Button() {
    const styleButton = "inline-flex items-center justify-center rounded-xl bg-fuchsia-950 px-5 py-2.5 mx-8 text-sm font-medium text-white shadow-sm transition-all duration-200 ease-in-out hover:bg-fuchsia-950 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-purple-500/40 focus:ring-offset-2 active:scale-[0.98] disabled:bg-fuchsia-300 disabled:cursor-not-allowed disabled:shadow-none";
    return (
        <>
